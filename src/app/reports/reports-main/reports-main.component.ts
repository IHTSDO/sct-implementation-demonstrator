...
export class ReportsMainComponent {
  ...
  reports: any[] = [
    ...
    { type: 'internal', name: 'FSN Changes', subtitle: "Changes Report", route: 'reports/fsn', 
      description: 'This report displays changes to the FSN of concepts over time.' },
    { type: 'internal', name: 'Inactivations', subtitle: "Changes Report", route: 'reports/inactivations', 
      description: 'This report displays concept inactivations over time.' },
    { type: 'internal', name: 'New Concepts', subtitle: "Changes Report", route: 'reports/new-concepts', 
